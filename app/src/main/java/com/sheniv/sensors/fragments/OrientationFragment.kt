...
import com.sheniv.sensors.databinding.FragmentOrientationBinding

class OrientationFragment : OneParameterBaseFragment<FragmentOrientationBinding>() {
    override fun createViewBinding(
        inflater: LayoutInflater,
        container: ViewGroup?
    ) = FragmentOrientationBinding.inflate(inflater, container, false)
