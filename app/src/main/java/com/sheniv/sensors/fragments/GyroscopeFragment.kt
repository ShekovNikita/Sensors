...
import com.sheniv.sensors.databinding.FragmentGyroscopeBinding

class GyroscopeFragment : OneParameterBaseFragment<FragmentGyroscopeBinding>() {
    override fun createViewBinding(
        inflater: LayoutInflater,
        container: ViewGroup?
    ) = FragmentGyroscopeBinding.inflate(inflater, container, false)
