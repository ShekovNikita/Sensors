...
import com.sheniv.sensors.databinding.FragmentMagneticFieldBinding

class MagneticFieldFragment : OneParameterBaseFragment<FragmentMagneticFieldBinding>() {
    override fun createViewBinding(
        inflater: LayoutInflater,
        container: ViewGroup?
    ) = FragmentMagneticFieldBinding.inflate(inflater, container, false)
