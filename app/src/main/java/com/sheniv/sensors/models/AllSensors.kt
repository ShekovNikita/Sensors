...
class AllSensors {
    ...
    private val sensorLight = SensorItem(R.drawable.light, R.string.sensor_light)
    private val sensorAccelerometer = SensorItem(R.drawable.accelerometer, R.string.sensor_accelerometer)
    private val sensorAmbientTemperature = SensorItem(R.drawable.temperature, R.string.sensor_thermometer)
    private val sensorGravity = SensorItem(R.drawable.light, R.string.sensor_gravity)
    private val sensorRelativeHumidity = SensorItem(R.drawable.light, R.string.humidity)
    private val sensorLinearAcceleration = SensorItem(R.drawable.light, R.string.linear_acceleration)
    ...
    private val sensorOrientation = SensorItem(R.drawable.light, R.string.orientation)
    private val sensorPressure = SensorItem(R.drawable.light, R.string.pressure)
    private val sensorProximity = SensorItem(R.drawable.proximity, R.string.proximity)
    private val sensorRotationVector = SensorItem(R.drawable.light, R.string.rotation_vector)
    ...
    private val level = SensorItem(R.drawable.level, R.string.level)
