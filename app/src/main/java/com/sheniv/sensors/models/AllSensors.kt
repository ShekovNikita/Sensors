...
class AllSensors {
    ...
    private val sensorGravity = SensorItem(R.drawable.gravity_uni, R.string.sensor_gravity)
    private val sensorRelativeHumidity = SensorItem(R.drawable.relative_humidity, R.string.humidity)
    private val sensorLinearAcceleration = SensorItem(R.drawable.linear_acceleration_uni, R.string.linear_acceleration)
    ...
    private val compass = SensorItem(R.drawable.compass_1, R.string.compass)
